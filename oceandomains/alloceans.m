...
%
% Syntax
%   XY = alloceans(upscale, buf)
%   XY = alloceans(upscale, buf, latlim, morebuffers)
%   XY = alloceans(__, 'Name', value)
%   [XY, p] = alloceans(__)
%
% Input arguments
...
function varargout = alloceans(varargin)
    ...
    oceanPoly = polyshape([[-180; 180; 180; -180] + lonOrigin, [-90; -90; 90; 90]]);
    oceanLatlim = [-90, 90];
    oceanLonlim = [-180, 180] + lonOrigin;
    % Find the coastline
